...
class _MyTaskDetailPageState extends State<MyTaskDetailPage> {
  ...
  void initState() {
    /* _getCreateUser(); */
    int id = int.parse(widget.taskDetail.create_id);
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: SingleChildScrollView(
                    //设置框中的内容，实现框中内容的滚动
                    child: Text(widget.taskDetail.desc),
                  ),
                ),
              ),
            ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: CircleAvatar(
                      child: Text(
                        "${widget.taskDetail.owner_name.toString().substring(0, 1)}", //取名字的第一个字
                ...
                onPressed: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (_) => ChatProjectPage(
                          task_id: widget.taskDetail.task_id,
